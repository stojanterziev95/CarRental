...
public class AdminDetailsImpl implements UserDetails {
    ...
    public AdminDetailsImpl(Long id, String username, String password, Collection<? extends GrantedAuthority> authorities) {
        this.id = id;
    ...
    public static AdminDetailsImpl build(Admin admin) {
        ...
        return new AdminDetailsImpl(admin.getId(), admin.getUsername(), admin.getPassword(), authorities);
    }
